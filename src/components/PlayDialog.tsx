...
export default function PlayDialog({
  ...
  // True when the streamed play log shows the TV couldn't be reached (off /
  // standby / wrong network) rather than a content or playback problem.
  const tvUnreachable = log.some((line) => isTvUnreachableMessage(line));
